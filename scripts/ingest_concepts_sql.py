...
Usage:
    # Run via your preferred database client (e.g., docker exec -i <container> psql ...)
    python scripts/ingest_concepts_sql.py | psql -U postgres -d postgres
...
# Default source path
DEFAULT_SOURCE = os.environ.get("CONCEPTS_SOURCE_PATH", "docs/COMPOSABLE_CONCEPTS")
