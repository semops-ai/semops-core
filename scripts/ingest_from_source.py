#!/usr/bin/env python3
"""
Source-based ingestion pipeline for SemOps.
...
Usage:
    ...
    python scripts/ingest_from_source.py --source my-source

    # Dry run (show what would be done)
    python scripts/ingest_from_source.py --source my-source --dry-run

    # Skip LLM classification
    python scripts/ingest_from_source.py --source my-source --no-llm
...
def run_ingestion(
    ...
    """
    console.print()
    console.print("[bold]SemOps Source Ingestion[/bold]")
    console.print("=" * 40)
    console.print()
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Ingest content from configured sources into SemOps"
    )
    parser.add_argument(
        "--source",
        type=str,
        help="Source configuration name (e.g., 'my-source')",
    )
    parser.add_argument(
        "--list",
        action="store_true",
