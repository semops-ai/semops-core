#!/usr/bin/env python3
"""
LLM classifier for SemOps ingestion pipeline.
...
CLASSIFICATION_SYSTEM_PROMPT = """You are a content classifier for the SemOps knowledge management system.
...
7. concept_ownership: One of:
   - "1p" if this concept was coined/invented by the project team
