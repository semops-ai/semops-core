...
Ingests patterns from semops-dx-orchestrator/schemas/pattern_v1.yaml into the pattern table,
...
# Paths
# ---------------------------------------------------------------------------
DX_HUB_PATH = Path(os.environ.get("DX_HUB_PATH", Path.home / "GitHub" / "semops-dx-orchestrator"))
