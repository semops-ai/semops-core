#!/usr/bin/env python3
"""
Lightweight markdown ingestion script for SemOps knowledge base.

Ingests markdown files from the configured docs directory into the Entity table.
...
# Default docs path
DEFAULT_DOCS_PATH = os.environ.get("DOCS_SOURCE_PATH", "docs")
